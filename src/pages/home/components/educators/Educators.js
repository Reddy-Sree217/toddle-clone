...
const LEFT_ARROW =
    "https://www.toddleapp.com/wp-content/uploads/2022/07/SyhikGY0t.webp";
const RIGHT_ARROW =
    "https://www.toddleapp.com/wp-content/uploads/2022/07/Sk09kMtRY.webp";
...
const Educators = () => {
    ...
    const handleLeftClick = () => {
        ...
        } else setActiveEducatorIndex((prev) => prev - 1);
    };
    ...
    return (
        ...
        >
            ...
            <Stack
                ...
                alignItems="center"
                width="60%"
                sx={{ position: "relative", background: "#fff", borderRadius: "20px" }}
            >
                <div
                ...
                <Stack gap={7} width="50%" p="50px">
                    <Typography fontSize="20px" fontWeight="500" lineHeight="34px">
                        {STUFF[EDUCATORS_LIST[activeEducatorIndex]]?.msg}
                    </Typography>
                    <Stack>
                        <Typography fontSize="20px" color="#222" fontWeight="600">
                            {STUFF[EDUCATORS_LIST[activeEducatorIndex]]?.name}
                        </Typography>
                        <Typography color="#717171">
                            {STUFF[EDUCATORS_LIST[activeEducatorIndex]]?.location}
                        </Typography>
                    </Stack>
                </Stack>
                <Stack width="480px" borderRadius="20px">
                    <img
                        src={STUFF[EDUCATORS_LIST[activeEducatorIndex]]?.img}
                        alt="educator_img"
                        style={{
                            background: STUFF[EDUCATORS_LIST[activeEducatorIndex]]?.bg_color,
